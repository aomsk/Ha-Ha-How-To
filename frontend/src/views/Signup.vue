        ...
        <div class="col-lg-5 m-auto">
            <form @submit.prevent="submitSignup()">
                ...
                <div class="mt-3">
                    ...
                    <input class="form-control" type="email" placeholder="example@gmail.com" for="email" v-model="singup.email">
                </div>
                <div class="mt-3">
                    <label class="form-lable mb-1">Password</label>
                    <input class="form-control" type="password" placeholder="8-20 ตัวอักษร" for="password" v-model="singup.passeord">
                </div>
                <div class="mt-3">
